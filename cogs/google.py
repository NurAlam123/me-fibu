...
class Google(commands.Cog):
    ...
    async def google(self, ctx, *, query=None):
        if query is None:
            # if user didn't send any word or sentence to search
            await ctx.send("You haven’t enter any word or sentence to search")
        else:
            ...
            # finding all anchor tag from html
