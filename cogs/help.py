...
def com_help(client,ctx):
			...
			msg.add_field(name='```!fibu quote```', value="Get a random quote", inline = False)
			...
			msg.add_field(name="```\n!fibu google <query>```",value="To get a search link", inline = False)
...
def info_help(client,ctx):
			...
			msg.add_field(name='```!fibu show your info```',value='Get information about me', inline = False)
	...
	async def help(self,ctx):
		if ctx.invoked_subcommand is None:
			...
			help_msg.add_field(name='Info',
					value='```!fibu help info```', inline = False)
			help_msg.add_field(name='Others', 	
					value='```!fibu help others```', inline = False)
